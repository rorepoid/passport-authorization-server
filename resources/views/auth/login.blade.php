...
@section('content')
    <section class="absolute w-full h-full top-0">
        <div id="app" class=" absolute top-0 w-full h-full bg-gray-900"
             style="background-image: url(); background-size: 100%; background-repeat: no-repeat;"></div>
            ...
            <div class="flex content-center items-center justify-center h-full">
                <div class="w-full lg:w-4/12 px-4 pt-32">
                    <div
                        ...
                        <div class="rounded-t mb-0 px-6 py-6">
                            <div class="text-center mb-3">
                                <h6 class="text-gray-600 text-xl font-bold">Sign in
                                    with {{ config('app.name', 'Roa-P') }}</h6></div>
                        ...
                        <div class="flex-auto px-4 lg:px-10 py-10 pt-0">
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <div class="relative w-full mb-3">
                                    <label class="block uppercase text-gray-700 text-xs font-bold mb-2 select-none"
                                ...
                                <div>
                                    <label class="inline-flex items-center cursor-pointer">
                                        <input
                                            ...
                                            style="transition: all 0.15s ease 0s;">
                                        <span
                                            class="ml-2 text-sm font-semibold text-gray-700 select-none">Remember me</span></label>
                                </div>
                    ...
                    <div class="flex flex-wrap mt-6">
                        <div class="w-1/2"><a href="#pablo" class="text-gray-300"><small>Forgot password?</small></a>
                        </div>
