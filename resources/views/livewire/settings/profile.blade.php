    ...
    <div class="mb-5 text-center">
        ...
        <form enctype="multipart/form-data">
            ...
            <label for="fileInput" type="button"
                   class="max-w-sm cursor-pointer inine-flex justify-between items-center focus:outline-none border py-2 px-4 rounded-lg shadow-sm text-left text-gray-600 bg-white hover:bg-gray-100 font-medium">
